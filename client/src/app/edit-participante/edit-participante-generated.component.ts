/*
  ...
  Modify edit-participante.component.ts instead.
*/
...
export class EditParticipanteGenerated implements AfterViewInit, OnInit, OnDestroy {
  // Components
  ...
  load() {
    ...
    this.pnld.getParticipanteByParticipante1(this.parameters.Participante1)
  ...
  form0Submit(event: any) {
    this.pnld.updateParticipante(this.parameters.Participante1, event)
    .subscribe((result: any) => {
      if (this.dialogRef) {
        this.dialogRef.close();
      } else {
      ...
      this.notificationService.notify({ severity: "error", summary: `Error`, detail: `Unable to update Participante` });
    });
  }
}
