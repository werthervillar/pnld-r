/*
  ...
  Modify add-passagem.component.ts instead.
*/
...
export class AddPassagemGenerated implements AfterViewInit, OnInit, OnDestroy {
  // Components
  ...
  load() {
    this.pnld.getTiposItensReembolsosDespesas(null, null, null, null, null, null, null, null)
