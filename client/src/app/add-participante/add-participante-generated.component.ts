/*
  ...
  Modify add-participante.component.ts instead.
*/
...
export class AddParticipanteGenerated implements AfterViewInit, OnInit, OnDestroy {
  // Components
  ...
  form0Submit(event: any) {
    this.pnld.createParticipante(event)
    .subscribe((result: any) => {
      if (this.dialogRef) {
        this.dialogRef.close();
      }
      ...
      this.notificationService.notify({ severity: "error", summary: `Error`, detail: `Unable to create new Participante!` });
    });
  }
}
