/*
  ...
  Modify acesso.component.ts instead.
*/
...
export class AcessoGenerated implements AfterViewInit, OnInit, OnDestroy {
  // Components
  ...
  login0Register(event: any) {
    this.dialogService.open(CadastrarUsuarioComponent, { parameters: {}, title: 'Cadastrar Usuário' });
  }
}
