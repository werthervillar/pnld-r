/*
  ...
  Modify edit-reunio.component.ts instead.
*/
...
export class EditReunioGenerated implements AfterViewInit, OnInit, OnDestroy {
  // Components
  ...
  load() {
    ...
    this.pnld.getReunioByReuniao(this.parameters.Reuniao)
  ...
  form0Submit(event: any) {
    this.pnld.updateReunio(this.parameters.Reuniao, event)
    .subscribe((result: any) => {
      if (this.dialogRef) {
        this.dialogRef.close();
      } else {
      ...
      this.notificationService.notify({ severity: "error", summary: `Error`, detail: `Unable to update Reunio` });
    });
  }
}
